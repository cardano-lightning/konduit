...
pub(crate) struct Args {
    ...
    #[clap(long, value_name = metavar::ED25519_PUBLIC_KEY, env = env::CONSUMER)]
    consumer: cardano::VerificationKey,

    /// Adaptor's verification key, allowed to *sub* funds
    #[clap(long, value_name = metavar::ED25519_PUBLIC_KEY, env = env::ADAPTOR)]
    ...
    close_period: konduit::TimeDelta,
}
