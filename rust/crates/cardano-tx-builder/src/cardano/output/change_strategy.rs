...
use crate::{Address, Output, Value, style};
use anyhow::anyhow;
...
impl ChangeStrategy {
    ...
    pub fn as_last_output(change_address: Address<style::Any>) -> Self {
    ...
    pub fn as_first_output(change_address: Address<style::Any>) -> Self {
        Self::new(move |change, outputs| {
