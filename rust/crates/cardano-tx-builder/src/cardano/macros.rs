...
///
/// ```rust
/// # use cardano_tx_builder::{address, address::{Address, kind}, script_credential};
...
///
/// ```rust
/// # use cardano_tx_builder::{address, address::{Address, kind}, key_credential};
...
///
/// ```rust
/// # use cardano_tx_builder::{address_test, address::{Address, kind}};
/// // From a string literal:
/// let my_address: Address<kind::Any> =
...
///
/// ```rust
/// # use cardano_tx_builder::{address_test, address::{Address, kind}, script_credential};
/// // From a script credential, using yet another macro:
/// assert_eq!(
...
///
/// ```rust
/// # use cardano_tx_builder::{address_test, address::{Address, kind}, key_credential};
/// // From key credentials, with delegation:
/// assert_eq!(
///   address_test!(
///     key_credential!("bd3ae991b5aafccafe5ca70758bd36a9b2f872f57f6d3a1ffa0eb777"),
...
///
/// ```rust
/// # use cardano_tx_builder::{PlutusVersion, plutus_script};
