...
- Era-prefixed support: `cardano-cli conway ...` exists and returns help without
  error.
- Legacy era flags: `--babbage-era` / `--alonzo-era` appear under
  `transaction build --help` or similar.
